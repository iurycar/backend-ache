...
create table `SHEETS` (
            ...
            `classe`			varchar(25)		default			"Indefinido",
...
insert into `EMPLOYEES` (`user_id`, `email`, `password_hash`, `first_name`, `last_name`, `role`, `cellphone`, `active`, `id_team`, `id_address`)
